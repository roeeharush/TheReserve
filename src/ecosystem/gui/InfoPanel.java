...
public class InfoPanel extends JPanel {
     ...
     * המתודה מציגה את נתוני המיקום ומצב החיות הכלליים ובודקת באמצעות מנגנון פולימורפי האם הישות היא ישות חיה ואם כן מציגה את רמות האנרגיה שלה ומדליקה את נראות הרכיבים המתאימים
     * @param entity הישות שנבחרה במפה וממנה מתבצעת שליפת הנתונים הנוכחית
     */
