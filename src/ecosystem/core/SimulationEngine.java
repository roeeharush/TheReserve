...
public class SimulationEngine {
    ...
    /**
     * מאתחלת ומפעילה את התהליכונים העצמאיים עבור כל הישויות הפעילות הקיימות בעולם
     * המתודה עוברת על רשימת הישויות מזהה את אלו בעלות יכולת תנועה ופעולה ומייצרת עבור כל אחת מהן תהליכון ייעודי המחובר לתור הפקודות המשותף
     */
    ...
    /**
     * עוצרת את כל התהליכונים הפעילים במערכת בצורה בטוחה ומסודרת בעת סגירת הסימולציה
     * המתודה פונה לכל תהליכון ברשימה ומפעילה את מנגנון העצירה הפנימי שלו כדי למנוע השארת תהליכונים תקועים בזיכרון ומרוקנת את מבני הנתונים
     */
